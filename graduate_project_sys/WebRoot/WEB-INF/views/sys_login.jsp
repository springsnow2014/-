...
<title>导师制管理系统-系统登录</title>
<link href="${pageContext.request.contextPath}/static/login/css/bootstrap.min.css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/static/login/css/a3common.css" rel="stylesheet">
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/login/css/login.css">
            <link rel="stylesheet" href="${pageContext.request.contextPath}/static/login/css/font_43459_lbtux0zjkr6yldi.css">
                ...
                <h2 class="text-center">导师制管理系统-系统登录</h2>
                
                
                <div>
                <div class="dataform" >
                
                <p style="margin-top:20px">登录名/工号/学号</p>
                <div>
                <input id="name" name="name" type="text" placeholder="请输入登录名/工号/学号" style="width:100%;height:40px;display:block" class="" class="inputs">
                </div>
                ...
                <button type="button" onclick="submitForm()" id="submitBtn" class="btn btn-block lgbtn blue">系统登录</button>
                </div>
                </div>
