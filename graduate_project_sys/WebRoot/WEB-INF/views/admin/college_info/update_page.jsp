...
<c:set var="uri" value="${pageContext.request.contextPath}" />
    ...
    var uri='${uri}';
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/admin/layui/css/layui.css">
            ...
            <input type="text"  style="display:inline;width:500px;" value="${data.cname}" placeholder="请输入学院名" id="cname" class="layui-input">	<span style="color:red">*必填</span>
                ...
                <div class="layui-input-block">
                <input type="text"  style="display:inline;width:500px;" value="${data.address}" placeholder="请输入学院地址" id="address" class="layui-input">	<span style="color:red">*必填</span>
                    ...
                    <input type="text"  style="display:inline;width:500px;" value="${data.contactTel}" placeholder="请输入联系电话" id="contactTel" class="layui-input">	<span style="color:red">*必填</span>
                        ...
                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                            ...
                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/layui/layui.js"></script>
                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=4306"></script>
                                    ...
                                    function submitData(){
                                        ...
                                        $.ajax({
                                            type: 'post',
                                            url: '${pageContext.request.contextPath}/admin/college_info/update_submit',
                                                data:{
                                                    "id":'${data.id}',
