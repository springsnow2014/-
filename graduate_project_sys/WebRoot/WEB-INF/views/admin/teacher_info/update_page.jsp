    ...
    var uri='${uri}';
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/admin/layui/css/layui.css">
            <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/webupload/webuploader.css">
                ...
                <input type="text"  style="display:inline;width:500px;" value="${data.tno}" placeholder="请输入工号" id="tno" class="layui-input">	<span style="color:red">*必填</span>
                                                    ...
                                                    <option value="${item.id}" selected>${item.name}</option>
                                                        ...
                                                        <c:if test="${item.id!=data.sex}">
                                                            <option value="${item.id}">${item.name}</option>
                                                                ...
                                                                <div class="layui-input-block">
                                                                <input type="text"  style="display:inline;width:500px;" value="${data.jobName}" placeholder="请输入职称" id="jobName" class="layui-input">	<span style="color:red">*必填</span>
                                                                    ...
                                                                    <c:forEach items="${isSelectList}" var="item">
                                                                        <c:if test="${item.id==data.isSelect}">
                                                                            <option value="${item.id}" selected>${item.name}</option>
                                                                                </c:if>
                                                                                <c:if test="${item.id!=data.isSelect}">
                                                                                    <option value="${item.id}">${item.name}</option>
                                                                                                                            ...
                                                                                                                            <option value="${item.id}">${item.name}</option>
                                                                                                                                ...
                                                                                                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                                                                                                                                    ...
                                                                                                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/layui/layui.js"></script>
                                                                                                                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=8829"></script>
