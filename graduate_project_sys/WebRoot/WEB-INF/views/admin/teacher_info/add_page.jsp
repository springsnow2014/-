    ...
    var uri='${uri}';
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/admin/layui/css/layui.css">
            <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/webupload/webuploader.css">
                ...
                <input type="text"  style="display:inline;width:500px;"  placeholder="请输入工号" id="tno" class="layui-input">	<span style="color:red">*必填</span>
                ...
                <div class="layui-input-block">
                <input type="text"  style="display:inline;width:500px;"  placeholder="请输入密码" id="password" class="layui-input">	<span style="color:red">*必填</span>
                ...
                <div class="layui-input-block">
                <input type="text"  style="display:inline;width:500px;"  placeholder="请输入姓名" id="realName" class="layui-input">	<span style="color:red">*必填</span>
                ...
                <div class="layui-input-block">
                <input type="text"  style="display:inline;width:500px;"  placeholder="请输入联系电话" id="celPhone" class="layui-input">	<span style="color:red">*必填</span>
                ...
                <div class="layui-input-block">
                <input type="text"  style="display:inline;width:500px;"  placeholder="请输入邮箱" id="email" class="layui-input">	<span style="color:red">*必填</span>
                ...
                <div class="layui-input-block">
                <textarea  placeholder="请输入教学简介"  id="personalIntro"  rows="15" cols="100"></textarea>	<span style="color:red">*必填</span>
                ...
                <div class="layui-input-block">
                <div class="imgUpload" tip="请上传电子照片，数量不超过1"  red-tip="(*必填)"  upload-num="1" init-val="" upload-type="1" id="headImg"></div>
                ...
                <c:forEach items="${sexList}" var="item">
                    <option value="${item.id}">${item.name}</option>
                        ...
                        <div class="layui-form-item layui-form-text" id="jobNameParentContent">
                        <label class="layui-form-label">职称</label>
                        <div class="layui-input-block">
                        <input type="text"  style="display:inline;width:500px;"  placeholder="请输入职称" id="jobName" class="layui-input">	<span style="color:red">*必填</span>
                        
                        </div>
                        </div>
                        
                        <div class="layui-form-item layui-form-text" id="isSelectParentContent">
                        <label class="layui-form-label">是否可选</label>
                        <div class="layui-input-block">
                        <select  id="isSelect" style="display:inline;height:30px;width:500px;" >
                                            ...
                                            <option value="${item.id}">${item.name}</option>
                                                ...
                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                                                    ...
                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/layui/layui.js"></script>
                                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=7457"></script>
