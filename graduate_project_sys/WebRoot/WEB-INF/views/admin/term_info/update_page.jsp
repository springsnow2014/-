...
<c:set var="uri" value="${pageContext.request.contextPath}" />
    ...
    var uri='${uri}';
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/admin/layui/css/layui.css">
            ...
            <div class="layui-form-item layui-form-text" id="tnameParentContent">
            <label class="layui-form-label">学期名</label>
            <div class="layui-input-block">
            <input type="text"  style="display:inline;width:500px;" value="${data.tname}" placeholder="请输入学期名" id="tname" class="layui-input">	<span style="color:red">*必填</span>
                
                </div>
                </div>
                
                <div class="layui-form-item layui-form-text" id="gidParentContent">
                <label class="layui-form-label">年级ID</label>
                <div class="layui-input-block">
                <select  id="gid" style="display:inline;height:30px;width:500px;" >
                <c:forEach items="${gradeInfoList}" var="item">
                    <c:if test="${item.id==data.gid}">
                                ...
                                <option value="${item.id}">${item.name}</option>
                                    ...
                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                                        ...
                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/layui/layui.js"></script>
                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=1727"></script>
