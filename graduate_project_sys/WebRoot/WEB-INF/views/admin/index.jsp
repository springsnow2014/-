...
<div class="layui-layout layui-layout-admin">
 ...
 <div class="layui-logo" style="width:300px;"><a  href="#" style="color:white">导师制管理系统</a></div>
  ...
  <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll" style="display:block">
     ...
     <li class="layui-nav-item layui-nav-itemed">
            ...
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="导师管理"    data-url="${pageContext.request.contextPath}/admin/teacher_info">导师管理  </a>  </dd><dd>  <a onclick="goPage(this)"  data-name="学生管理"    data-url="${pageContext.request.contextPath}/admin/student_info">学生管理  </a>  </dd>
            </dl>
			</li><li class="layui-nav-item layui-nav-itemed">
            <a href="javascript:;">学生项目申请 </a>
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="学生项目申请"    data-url="${pageContext.request.contextPath}/admin/stu_apply_log">学生项目申请  </a>  </dd>
            </dl>
			</li><li class="layui-nav-item layui-nav-itemed">
            <a href="javascript:;">学院管理 </a>
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="学院管理"    data-url="${pageContext.request.contextPath}/admin/college_info">学院管理  </a>  </dd><dd>  <a onclick="goPage(this)"  data-name="班级管理"    data-url="${pageContext.request.contextPath}/admin/class_info">班级管理  </a>  </dd><dd>  <a onclick="goPage(this)"  data-name="年级管理"    data-url="${pageContext.request.contextPath}/admin/grade_info">年级管理  </a>  </dd><dd>  <a onclick="goPage(this)"  data-name="学期管理"    data-url="${pageContext.request.contextPath}/admin/term_info">学期管理  </a>  </dd><dd>  <a onclick="goPage(this)"  data-name="研究方向管理"    data-url="${pageContext.request.contextPath}/admin/research_info">研究方向管理  </a>  </dd>
            </dl>
			</li>
