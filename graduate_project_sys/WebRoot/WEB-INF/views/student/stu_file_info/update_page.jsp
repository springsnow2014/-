        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/admin/layui/css/layui.css">
            <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/webupload/webuploader.css">
                ...
                <input type="text"  style="display:inline;width:500px;" value="${data.title}" placeholder="请输入标题" id="title" class="layui-input">	<span style="color:red">*必填</span>
                    ...
                    <div class="layui-input-block">
                    <textarea  placeholder="请输入简介"  id="fileIntro"  rows="15" cols="100">${data.fileIntro}</textarea>	<span style="color:red">*必填</span>
                        ...
                        <div class="layui-input-block">
                        <div class="imgUpload" tip="请上传文件，数量不超过1" red-tip="(*必填)"   upload-num="1" init-val="${data.fileUrl}" upload-type="4" id="fileUrl"></div>
                            ...
                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                                ...
                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/layui/layui.js"></script>
                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=9531"></script>
                                            ...
                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/webupload/upload.js"></script>
                                                ...
                                                $(function(){
                                                    ...
                                                    function submitData(){
                                                        ...
                                                        $.ajax({
                                                            type: 'post',
                                                            url: '${pageContext.request.contextPath}/student/stu_file_info/update_submit',
                                                                data:{
                                                                    "id":'${data.id}',
