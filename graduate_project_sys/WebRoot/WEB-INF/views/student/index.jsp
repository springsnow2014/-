  ...
  <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll" style="display:block">
     ...
     <li class="layui-nav-item layui-nav-itemed">
            ...
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="个人信息"    data-url="${pageContext.request.contextPath}/student/student_info/detail">个人信息  </a>  </dd>
            </dl>
			</li><li class="layui-nav-item layui-nav-itemed">
            <a href="javascript:;">导师查询 </a>
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="导师查询"    data-url="${pageContext.request.contextPath}/student/teacher_info">导师查询  </a>  </dd>
            </dl>
			</li><li class="layui-nav-item layui-nav-itemed">
            <a href="javascript:;">我的申请 </a>
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="我的申请"    data-url="${pageContext.request.contextPath}/student/stu_apply_log">我的申请  </a>  </dd>
            </dl>
			</li>
