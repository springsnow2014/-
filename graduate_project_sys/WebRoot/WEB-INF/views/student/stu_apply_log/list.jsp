                            ...
                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/page/myPagination.js"></script>
                                ...
                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/layui/layui.js"></script>
                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/layuiutil.js"></script>
                                        ...
                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=8756"></script>
                                            ...
                                            function ajaxList(page) {
                                                ...
                                                showLoading('${pageContext.request.contextPath}/static/common/loading.gif');
                                                    $.ajax({
                                                        type : 'get',
                                                        url : "${pageContext.request.contextPath}/student/stu_apply_log/queryList",
                                                            data : {
                                                                ...
                                                                success : function(result) {
                                                                    ...
                                                                    for (var i = 0; i < rows.length; i++) {
                                                                        ...
                                                                        if(profileStr!=null){
                                                                            ...
                                                                            html+='<td>';
                                                                            if(rows[i].stuApplyLog.selectStatus=='1'){
                                                                                html+='<a href="${pageContext.request.contextPath}/student/stu_apply_log/qx?id='+rows[i].stuApplyLog.id+'&teacherId=${data.teacherId}&selectStatus=${data.selectStatus}" class="layui-btn layui-btn-danger layui-btn-radius btnStyle">取消</a>';
                                                                                }
                                                                                if(rows[i].stuApplyLog.selectStatus=='2'){
                                                                                    html+='<a href="javascript:void(0)" data-url="${pageContext.request.contextPath}/student/stu_file_info?projectId='+rows[i].stuApplyLog.id+'" page-name="项目文档" onclick="gotoPage(this)"  class="layui-btn layui-btn-radius btnStyle">文档管理</a>';
                                                                                    }
                                                                                    if(rows[i].stuApplyLog.selectStatus=='2'){
                                                                                        html+='<a href="javascript:void(0)" data-url="${pageContext.request.contextPath}/student/teacher_eval?projectId='+rows[i].stuApplyLog.id+'" page-name="学业评分" onclick="gotoPage(this)"  class="layui-btn layui-btn-radius btnStyle">评价管理</a>';
                                                                                        }
                                                                                        if(rows[i].stuApplyLog.selectStatus=='2'){
                                                                                            html+='<a href="${pageContext.request.contextPath}/commonapi/chat/chat?targetId='+rows[i].stuApplyLog.teacherId+'" target="_blank"  class="layui-btn layui-btn-warm layui-btn-radius btnStyle">和TA聊</a>';
                                                                                            }
                                                                                            html+='</td>';
                                                                                            html+='</tr>';
                                                                                        }
