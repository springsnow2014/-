                                        ...
                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/page/myPagination.js"></script>
                                            ...
                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/layui/layui.js"></script>
                                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/layuiutil.js"></script>
                                                    ...
                                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=2667"></script>
                                                            ...
                                                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/selectSearch/jquery.searchableSelect.js?d=124393"></script>
                                                                ...
                                                                function ajaxList(page) {
                                                                    ...
                                                                    showLoading('${pageContext.request.contextPath}/static/common/loading.gif');
                                                                        $.ajax({
                                                                            type : 'get',
                                                                            url : "${pageContext.request.contextPath}/student/teacher_info/queryList",
                                                                                data : {
                                                                                ...
                                                                                success : function(result) {
                                                                                    ...
                                                                                    for (var i = 0; i < rows.length; i++) {
                                                                                        ...
                                                                                        if(headImgStr!=null){
                                                                                            ...
                                                                                            html+='<td>';
                                                                                            if(rows[i].canSelect=='1'){
                                                                                                html+='<a href="javascript:void(0)" data-url="${pageContext.request.contextPath}/student/stu_apply_log/select_turtor?teacherId='+rows[i].teacherInfo.id+'" page-name="学生项目申请" onclick="gotoPage(this)"  class="layui-btn layui-btn-radius btnStyle">选择导师</a>';
                                                                                                }
                                                                                                html+='</td>';
                                                                                                html+='</tr>';
                                                                                            }
                                                                                ...
                                                                                function changeCollegeIdVal(){
                                                                                    ...
                                                                                    $.ajax({
                                                                                        async:false,
                                                                                        type: 'post',
                                                                                        url: '${pageContext.request.contextPath}/student/teacher_info/getResearchInfoListByCid',
                                                                                            data:{
                                                                                                "cid":id
                                                                                            },
                                                                                            success: function(result) {
