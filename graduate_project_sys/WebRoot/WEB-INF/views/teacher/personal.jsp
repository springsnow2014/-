                    ...
                    <th width="90%"  >${detail.teacherInfo.tno}</th>
                        ...
                        <th width="90%"  >${detail.teacherInfo.realName}</th>
                            ...
                            <th width="90%"  >${detail.teacherInfo.celPhone}</th>
                                ...
                                <tr>
                                <th width="10%">邮箱</th>
                                <th width="90%"  >${detail.teacherInfo.email}</th>
                                    </tr>
                                    <tr>
                                    <th width="10%">教学简介</th>
                                    <th width="90%"  >${detail.teacherInfo.personalIntro}</th>
                                        </tr>
                                        <tr>
                                        <th width="10%">电子照片</th>
                                        <th width="90%" ><img src="${detail.teacherInfo.headImg}" style="width:200px"  /></th>
                                            </tr>
                                            <tr>
                                            <th width="10%">性别</th>
                                            <th width="90%"  >${detail.sexStr}</th>
                                                ...
                                                <tr>
                                                <th width="10%">职称</th>
                                                <th width="90%"  >${detail.teacherInfo.jobName}</th>
                                                    </tr>
                                                    <tr>
                                                    <th width="10%">是否可选</th>
                                                    <th width="90%"  ><c:choose>
                                                    <c:when test="${detail.teacherInfo.isSelect=='1'}">
                                                        <span class="layui-badge layui-bg-green"  style="width:80px;">${detail.isSelectStr}</span>
                                                            </c:when>
                                                            <c:when test="${detail.teacherInfo.isSelect=='2'}">
                                                                <span class="layui-badge"  style="width:80px;">${detail.isSelectStr}</span>
                                                                    </c:when>
                                                                    <c:otherwise>
                                                                    ${detail.isSelectStr}
                                                                        </c:otherwise>
                                                                        ...
                                                                        <tr>
                                                                        <th width="10%">已选学生数</th>
                                                                        <th width="90%"  >${detail.teacherInfo.selectedNum}</th>
                                                                            </tr>
                                                                            <tr>
                                                                            <th width="10%">所属学院</th>
                                                                            <th width="90%"   id=collegeIdStr>${detail.collegeIdStr}</th>
                                                                                ...
                                                                                <th width="90%"   id=researchIdStr>${detail.researchIdStr}</th>
                                                                                    ...
                                                                                    <a href="${pageContext.request.contextPath}/teacher/teacher_info/update2?id=${detail.teacherInfo.id}" class="layui-btn layui-btn-normal layui-btn-radius">修改</a>
                                                                                        </div>
