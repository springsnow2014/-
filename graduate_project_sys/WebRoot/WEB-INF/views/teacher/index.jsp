      ...
      <li class="layui-nav-item">
        ...
        <dl class="layui-nav-child">
          <dd><a href="javascript:void(0)" onclick="alterPassword()">修改密码</a></dd>
			...
			<li  class="layui-nav-item"><a href="${pageContext.request.contextPath}/commonapi/chat/chat" target="_blank">聊天室(<span style="color:red">${chatNewMsgNum})</span></a></li>
  ...
  <div class="layui-side layui-bg-black">
    <div class="layui-side-scroll" style="display:block">
     ...
     <li class="layui-nav-item layui-nav-itemed">
            ...
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="个人信息"    data-url="${pageContext.request.contextPath}/teacher/teacher_info/detail">个人信息  </a>  </dd>
            </dl>
			</li><li class="layui-nav-item layui-nav-itemed">
            <a href="javascript:;">申请管理 </a>
            <dl class="layui-nav-child">
                 <dd>  <a onclick="goPage(this)"  data-name="待审核申请"    data-url="${pageContext.request.contextPath}/teacher/stu_apply_log?1=1&selectStatus=1">待审核申请  </a>  </dd><dd>  <a onclick="goPage(this)"  data-name="已同意的申请"    data-url="${pageContext.request.contextPath}/teacher/stu_apply_log?1=1&selectStatus=2">已同意的申请  </a>  </dd><dd>  <a onclick="goPage(this)"  data-name="已拒绝的申请"    data-url="${pageContext.request.contextPath}/teacher/stu_apply_log?1=1&selectStatus=3">已拒绝的申请  </a>  </dd><dd>  <a onclick="goPage(this)"  data-name="已取消的申请"    data-url="${pageContext.request.contextPath}/teacher/stu_apply_log?1=1&selectStatus=4">已取消的申请  </a>  </dd>
            </dl>
			</li>
