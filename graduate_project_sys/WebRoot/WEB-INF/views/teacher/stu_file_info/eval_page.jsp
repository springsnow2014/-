...
<c:set var="uri" value="${pageContext.request.contextPath}" />
    ...
    var uri='${uri}';
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/admin/layui/css/layui.css">
            ...
            <legend>评阅-项目文档</legend>
            <div class="layui-field-box">
            <div >
            
            
            <div class="layui-form-item layui-form-text" id="teacherEvalParentContent">
            <label class="layui-form-label">导师评语</label>
            <div class="layui-input-block">
            <textarea  placeholder="请输入导师评语"  id="teacherEval"  rows="15" cols="100">${data.teacherEval}</textarea>	<span style="color:red">*必填</span>
                ...
                <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                    ...
                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/layui/layui.js"></script>
                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=1447"></script>
                            ...
                            function submitData(){
                                var teacherEval= $('#teacherEval').val();
                                
                                $.ajax({
                                    type: 'post',
                                    url: '${pageContext.request.contextPath}/teacher/stu_file_info/eval_submit',
                                        data:{
                                            "id":'${data.id}',
