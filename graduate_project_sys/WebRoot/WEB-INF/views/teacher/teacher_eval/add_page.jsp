...
<c:set var="uri" value="${pageContext.request.contextPath}" />
    ...
    var uri='${uri}';
        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/admin/layui/css/layui.css">
            ...
            <textarea  placeholder="请输入思想品德"  id="ideologicalmoral"  rows="15" cols="100"></textarea>	<span style="color:red">*必填</span>
            ...
            <div class="layui-input-block">
            <textarea  placeholder="请输入学习能力"  id="learningability"  rows="15" cols="100"></textarea>	<span style="color:red">*必填</span>
            ...
            <div class="layui-input-block">
            <textarea  placeholder="请输入专业技能"  id="professionalSkills"  rows="15" cols="100"></textarea>	<span style="color:red">*必填</span>
            ...
            <div class="layui-input-block">
            <textarea  placeholder="请输入实践"  id="practive"  rows="15" cols="100"></textarea>	<span style="color:red">*必填</span>
            ...
            <div class="layui-input-block">
            <input type="text"  style="display:inline;width:500px;"  placeholder="请输入论文成绩（请输入数字）" id="papergrade" class="layui-input">	<span style="color:red">*必填</span>
            ...
            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/jquery-1.11.1.min.js"></script>
                ...
                <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/layui/layui.js"></script>
                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=0343"></script>
                        ...
                        function submitData(){
                            ...
                            $.ajax({
                                type: 'post',
                                url: '${pageContext.request.contextPath}/teacher/teacher_eval/add_submit',
                                    data:{
