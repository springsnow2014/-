        ...
        <link rel="stylesheet" href="${pageContext.request.contextPath}/static/admin/css/global.css">
            <link rel="stylesheet" href="${pageContext.request.contextPath}/static/admin/icheck/minimal/red.css">
                <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/common/page/myPagination.css?t=4" />
                    ...
                    <a href="${pageContext.request.contextPath}/teacher/teacher_eval/add?projectId=${data.projectId}" class="layui-btn layui-btn-radius">新增</a>
                            ...
                            <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/page/myPagination.js"></script>
                                ...
                                <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/layui/layui.js"></script>
                                    <script type="text/javascript" src="${pageContext.request.contextPath}/static/admin/layuiutil.js"></script>
                                        ...
                                        <script type="text/javascript" src="${pageContext.request.contextPath}/static/common/utils/listutils.js?v=6976"></script>
                                            ...
                                            function ajaxList(page) {
                                                ...
                                                showLoading('${pageContext.request.contextPath}/static/common/loading.gif');
                                                    $.ajax({
                                                        type : 'get',
                                                        url : "${pageContext.request.contextPath}/teacher/teacher_eval/queryList",
                                                            data : {
                                                                ...
                                                                success : function(result) {
                                                                    ...
                                                                    for (var i = 0; i < rows.length; i++) {
                                                                        ...
                                                                        html+='<td>';
                                                                        html+='<a href="${pageContext.request.contextPath}/teacher/teacher_eval/update?id='+rows[i].teacherEval.id+'&projectId=${data.projectId}" class="layui-btn layui-btn-normal layui-btn-radius btnStyle">修改</a>';
                                                                            html+='<a href="javascript:void(0)" onclick="del(this)" data-id="'+rows[i].teacherEval.id+'" class="layui-btn layui-btn-danger layui-btn-radius btnStyle">删除</a>';
                                                                            html+='</td>';
                                                                            html+='</tr>';
                                                                        }
                                                                        if (rows.length == 0) {
                                                            ...
                                                            function del(e){
                                                                if(window.confirm('你确定要删除该学业评分吗')){
                                                                    var id = $(e).attr("data-id");
                                                                    $.ajax({
                                                                        type : 'get',
                                                                        url : "${pageContext.request.contextPath}/teacher/teacher_eval/del",
                                                                            data : {
                                                                                "id":id
                                                                            },
                                                                            success : function(result) {
